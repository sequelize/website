...
node-oracledb needs [instant client library files](https://www.oracle.com/in/database/technologies/instant-client/downloads.html) to work. Installation process can be found on link mentioned above.
