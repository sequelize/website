...
Sequelize provides [a lot of built-in data types](https://github.com/sequelize/sequelize/blob/main/src/data-types.ts). To access a built-in data type, you must import `DataTypes`:
