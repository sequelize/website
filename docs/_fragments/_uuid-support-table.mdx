...
| `uuidV4` | [`gen_random_uuid`](https://www.postgresql.org/docs/current/functions-uuid.html)                    | N/A                                       | N/A                                                                                          | [`NEWID`](https://learn.microsoft.com/en-us/sql/t-sql/functions/newid-transact-sql?view=sql-server-ver16) | N/A    | N/A       | N/A | N/A  |
