...
One `sequelize.close()` has been called, it's impossible to reopen a connection. You will need to create a new Sequelize instance to access your database again.
