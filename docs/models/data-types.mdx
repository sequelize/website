...
| -------------------------------------------------------------------------------- | --------------------------------------------------------------- | ---------------------------------- | ---------------------------- | ------------------------------ | -------------------------- | ----------------------------------------------------------------------------- | --------------------------- | --------------------------- | --------------------- |
| [`STRING`](pathname:///api/v7/classes/_sequelize_core.index.unknown.STRING.html) | [`VARCHAR(255)`][postgres-char]                                 | [`VARCHAR(255)`][mariadb-varchar]  | [`VARCHAR(255)`][mysql-char] | [`NVARCHAR(255)`][mssql-nchar] | `TEXT`                     | `VARCHAR(255)`                                                                | `VARCHAR(255)`              | `VARCHAR(255)`              | `NVARCHAR2(255)`      |
| `STRING(100)`                                                                    | `VARCHAR(100)`                                                  | `VARCHAR(100)`                     | `VARCHAR(100)`               | `NVARCHAR(100)`                | `TEXT`                     | `VARCHAR(100)`                                                                | `VARCHAR(100)`              | `VARCHAR(100)`              | `NVARCHAR2(100)`      |
| `STRING.BINARY`                                                                  | ❌                                                              | `VARCHAR(255) BINARY`              | `VARCHAR(255) BINARY`        | ❌                             | `TEXT COLLATE BINARY`      | `VARCHAR(255) BINARY`                                                         | `VARCHAR(255) FOR BIT DATA` | `VARCHAR(255) FOR BIT DATA` | `RAW(255)`            |
...
| [`TEXT`](pathname:///api/v7/classes/_sequelize_core.index.unknown.TEXT.html)     | [`TEXT`][postgres-char]                                         | [`TEXT`][mariadb-text]             | [`TEXT`][mysql-text]         | `NVARCHAR(MAX)`                | `TEXT`                     | `TEXT`                                                                        | `CLOB(2147483647)`          | `CLOB(2147483647)`          | `CLOB`                |
...
| [`CHAR`](pathname:///api/v7/classes/_sequelize_core.index.unknown.CHAR.html)     | [`CHAR(255)`][postgres-char]                                    | [`CHAR(255)`][mariadb-char]        | [`CHAR(255)`][mysql-char]    | [`CHAR(255)`][mssql-char]      | ❌                         | `CHAR(255)`                                                                   | `CHAR(255)`                 | `CHAR(255)`                 | `CHAR(255)`           |
...
| Sequelize DataType | PostgreSQL                                                        | MariaDB                                             | MySQL                                                       | MSSQL           | [SQLite][sqlite-datatypes] | Snowflake | db2 | ibmi | Oracle                                                                  |
| ------------------ | ----------------------------------------------------------------- | --------------------------------------------------- | ----------------------------------------------------------- | --------------- | -------------------------- | --------- | --- | ---- | ----------------------------------------------------------------------- |
| `JSON`             | [`JSON`](https://www.postgresql.org/docs/9.4/datatype-json.html)  | [`JSON`](https://mariadb.com/kb/en/json-data-type/) | [`JSON`](https://dev.mysql.com/doc/refman/8.0/en/json.html) | `NVARCHAR(MAX)` | `TEXT`                     | ❌        | ❌  | ❌   | [`BLOB`](https://docs.oracle.com/database/121/ADXDB/json.htm#ADXDB6246) |
...
[oracle-date]: https://docs.oracle.com/cd/B28359_01/server.111/b28318/datatype.htm#CNCPT413
[oracle-float]: https://docs.oracle.com/cd/B28359_01/server.111/b28318/datatype.htm#i22294
[oracle-decimal]: https://docs.oracle.com/cd/B28359_01/server.111/b28318/datatype.htm#i22289
