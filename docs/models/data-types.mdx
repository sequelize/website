...
Sequelize provides a special syntax to query the contents of a JSON object. [Read more about querying JSON](../querying/json.md).
...
`DataTypes.VIRTUAL` is a special DataType used to declare [virtual attributes](../other-topics/getters-setters-virtuals.md#virtual-fields).
