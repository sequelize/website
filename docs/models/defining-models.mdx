...
:::warning Issue with Public Class Fields

Sequelize currently has a bug where adding a Public Class Field shadows the setter & getters that sequelize adds for all model attributes. 

[We are working on this issue](https://github.com/sequelize/meetings/issues/16). Until we've resolved that issue, you can use the workaround described in [this comment](https://github.com/sequelize/sequelize-typescript/issues/778#issuecomment-1007615424).
