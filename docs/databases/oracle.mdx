...
In Sequelize v7, node-oracledb uses thin mode by default which **doesn't require** to install [Oracle Client](https://www.oracle.com/database/technologies/instant-client/downloads.html) libraries.
...
1. Install the [Oracle Instant Client binaries](https://www.oracle.com/database/technologies/instant-client/downloads.html) on your operating system.
...
2. Call `initOracleClient()` at the very beginning of your application entry point as shown below:
