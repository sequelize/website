---
title: Oracle for LUW
sidebar_position: 1
---

# Sequelize for Oracle Database for Linux, Unix, and Windows

:::info Version Compatibility

See [Releases](/releases#oracle-for-luw-support-table) to see which versions of Oracle Database for LUW are supported.

:::

To use Sequelize with Oracle Database for LUW, you need to install the `@sequelize/oracle` dialect package:
...
The following options are accepted by the Oracle Database for LUW dialect:

| Option                    | Description                                                                                                                           |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `database`                | Oracle "serviceName" to use for this connection                                                                                       |
| `user`                    | Oracle database user to authenticate as                                                                                               |
...
| `connectionString`        | The connectString of the database instance to connect to.                                                                             |
...
| `oracleOptions`           | Additional Oracle database parameters.                                                                                                |
