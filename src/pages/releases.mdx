...
In Sequelize 6, PostgreSQL requires the use of the [pg][pg] (or [pg-native]) npm package.
...
In Sequelize 6, MariaDB requires the use of the [mariadb][mariadb-npm] npm package.
...
In Sequelize 6, MySQL requires the use of the [mysql2] npm package.
...
In Sequelize 6, MSSQL requires the use of the [tedious] npm package.
...
In Sequelize 6, Sequelize uses the `sqlite3` npm library.
...
In Sequelize 6, Snowflake requires the use of the [snowflake-sdk] npm package.
...
In Sequelize 6, Oracle Database requires the use of the [node-oracledb] npm package.
