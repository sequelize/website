...
In Sequelize 6, Oracle requires the installation of the [node-oracledb] npm package.
[Read more about this here](/docs/v6/other-topics/dialect-specific-things/#oracle).

| Sequelize   | [Oracle] | [node-oracledb] |
| ----------- | -------- | --------------- |
| 7 (alpha)   | >= 18.4  | N/A[^1]         |
